let menu = document.querySelector(".header-conteiner_menu")
let telephone = document.querySelector(".header-conteiner_info__telephone")
let lang = document.querySelector(".header-conteiner__lang")
let burgerMenuOpen = document.querySelector(".btn-burger")
